...
import { Option, TreeNode } from "../../models/common.model";
import { DATE_FORMAT_ENUM } from "../enums/common.enums";
import { parseDateTime } from "./date-time-utils";
import { ACTIVE_STATUS, DISPLAY_STATUS, PARAM_STATUS } from "../constants";
...
export class CommonUtils {
  ...
  public static parseDateField(
    dateField: string | null | undefined | Date,
    formatDate: DATE_FORMAT_ENUM
  ): [TuiDay, TuiTime] | null {
    if (dateField !== null && dateField !== undefined) {
      return typeof dateField === 'string'
        ? parseDateTime(dateField, formatDate)
        : null;
    }
    return null;
  }
