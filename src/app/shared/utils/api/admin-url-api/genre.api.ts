...
export class GenreUrlApi {
  ...
  CommonUrlApi.ADMIN_SERVICE_MODULE.GENRE.concat('/get-agent-options');
  public static readonly GET_ALL_GENRE_NAME_ACTIVE =
  CommonUrlApi.ADMIN_SERVICE_MODULE.GENRE.concat('/get-agent-name-options');
  public static readonly GET_SERTYPE =
  CommonUrlApi.ADMIN_SERVICE_MODULE.GENRE.concat('/get-agent-sertype-search');
